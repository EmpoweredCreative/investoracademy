...
interface JournalCsvImportProps {
  accountId: string;
  onCommitted?: () => void;
}

export function JournalCsvImport({ accountId, onCommitted }: JournalCsvImportProps) {
      ...
      <div className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Use this CSV template to format your trade data. Columns match the journal: symbol, action (BTO/STO/BTC/STC), quantity, price, dates, and optional notes.
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Upload your trade CSV to import into this account&apos;s journal and ledger.
            </CardDescription>
          </CardHeader>

          {error && (
            <div className="mx-4 mb-4 p-3 rounded-lg bg-danger/10 border border-danger/20 text-danger text-sm">
              {error}
            </div>
          )}
            ...
            <div>
              ...
              >
                <input
                  ...
                  className="hidden"
                  id="journal-csv-upload"
                />
                <label htmlFor="journal-csv-upload" className="cursor-pointer">
                  {file ? (
